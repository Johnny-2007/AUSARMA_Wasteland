...
private ["_side","_faction","_result","_missionMarkerName","_missionType","_startTime","_returnData","_randomPos","_randomIndex","_vehicleClass","_vehicle","_picture","_vehicleName","_hint","_currTime","_playerPresent","_unitsAlive"];
...
_vehicleClass = ["BAF_Jackal2_L2A1_w","ArmoredSUV_PMC","HMMWV_M998A2_SOV_DES_EP1","BAF_Jackal2_L2A1_D"] call BIS_fnc_selectRandom;
...
EnemyGrpS = createGroup _side;
[EnemyGrpS,_randomPos,_side] spawn createSmallGroup;
...
waitUntil
{
    ...
    _unitsAlive = ({alive _x} count units EnemyGrpS);
...
if(_result == 1) then
{
    ...
    {deleteVehicle _x;}forEach units EnemyGrpS;
    deleteGroup EnemyGrpS;
