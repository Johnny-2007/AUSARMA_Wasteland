...
EnemyGrpOther = createGroup _side;
[EnemyGrpOther,_randomPos,_side]execVM "server\missions\createUnits\largeGroup.sqf";
[EnemyGrpOther, _randomPos] call BIS_fnc_taskDefend;
...
waitUntil
{
    ...
    _unitsAlive = ({alive _x} count units EnemyGrpOther);
