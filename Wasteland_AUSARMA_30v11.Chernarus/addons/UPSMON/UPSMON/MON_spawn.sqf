/* =====================================================================================================
 ...
 =====================================================================================================
	Parámeters: [Param1,Param2,Param3,[Param4]]  EXECVM "addons\UPSMON\UPSMON\MON_SPAWN.SQF";	
  ...
  =====================================================================================================
	...
	1- create a squad in editor. Exec UPSMON and set TEMPLATE id, this will save members of squad, not equipement.		
		nul = [this,"town","TEMPLATE:",1] execVM "addons\UPSMON\upsmon.sqf";	
	2- Exec MON_spawn on trigger or where you want telling the copy of the template to create
		and the position.
		nul = [1,[0,0,0],3,[mark, upsmon optional params]] EXECVM "addons\UPSMON\UPSMON\MON_SPAWN.SQF";		
 =====================================================================================================*/
