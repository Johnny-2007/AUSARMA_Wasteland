/*  =====================================================================================================
 ...
 =====================================================================================================		
	Parámeters: [_artillery,(_range,_rounds,_area,_cadence,_mincadence)] execvm "addons\UPSMON\UPSMON\MON_artillery_add.sqf";	
 ...
 =====================================================================================================
	...
	2. Exec module in int of static weapon
		...
		nul=[this] execVM "addons\UPSMON\UPSMON\MON_artillery_add.sqf";
