...
//{
	...
	//if (leader _x == _x) then {
        //hint ["Adding Follow Leader"];
		//_x addaction ["Order your men to follow me", "addons\UPSMON\UPSMON\actions\followme.sqf", [], 1, false];
	//} else {
        //hint ["Adding Follow"];
		//_x addaction ["Follow me", "addons\UPSMON\UPSMON\actions\followme.sqf", [], 1, false];
	//};
