...
ammoArray = [
    ...
    ["5Rnd 338 Lapua","5Rnd_86x70_L115A1",30],
...
generalStore = [
	["Water","water",localize "STR_WL_ShopDescriptions_Water","client\icons\water.paa",50,15],
	["Canned Food","canfood",localize "STR_WL_ShopDescriptions_CanFood","client\icons\cannedfood.paa",50,15],
	["Repair Kit","repairkits",localize "STR_WL_ShopDescriptions_RepairKit","client\icons\repair.paa",500,250],
	["Medical Kit","medkits",localize "STR_WL_ShopDescriptions_MedKit","client\icons\medkit.paa",100,200],
...
BuildStoreArray = [
	...
	["Misc, Camo Net", 25, "Land_CamoNet_NATO"],
	...
	["Tent, MASH", 400, "MASH"],
	["Tent, Storage", 25, "Land_tent_east"],
