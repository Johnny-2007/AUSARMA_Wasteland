...
weaponsArray = [
	...
	[2, "M4A1 RCO GL","M4A1_RCO_GL",300,150],   
	[2, "Sa-58V","Sa58V_EP1",180,90],
	[2, "Sa-58 CCO","Sa58V_CCO_EP1",200,100],
	[2, "Sa-58V ACOG","Sa58V_RCO_EP1",250,125],
	[2, "M8","m8_carbine",150,75],
	[2, "M8 Compact","m8_compact",150,75],
	[2, "M8 Compact CCO","m8_compact_pmc",180,90],
	[2, "M8 Holo SD","m8_holo_sd",200,100],
	[2, "M8 Sharpshooter","m8_sharpshooter",250,125],
	...
	[4, "M240","M240",250,125],
	[4, "RPK","RPK_74",200,150],
	[4, "PKM","PK",250,125],
	[4, "PKP","Pecheneg",350,175],
	[4, "M60E4","M60A4_EP1",400,200],
...
generalStore = [
	...
	["Spawn Beacon","spawnBeacon",localize "STR_WL_ShopDescriptions_spawnBeacon","client\icons\satellite.paa",1500,1000],
	["Camo Net", "camonet", localize "STR_WL_ShopDescriptions_Camo", "client\icons\tent.paa",50,25]  
];
...
BuildStoreArray = [
	...
	["Ramp, Earthern Rampart", 25, "Land_fort_rampart"],
	["Ramp, Scaffolding (high) ", 25, "Land_Misc_Scaffolding"],
	["Ramp, Scaffolding", 25, "Land_leseni2x"],
	["Ramp, Wooden Bridge", 25, "Land_prebehlavka"],
	["Roadblock, Concrete, Striped", 10, "Land_CncBlock_Stripes"],
	["Roadblock, Concrete Teeth", 50, "Hhedgehog_concreteBig"],
	...
	["Wall, Sandbag (corner)", 10, "Land_fort_bagfence_corner"],
	["Wall, Sandbag (long)", 10, "Land_fort_bagfence_long"],
	["Wall, Sandbag (round)", 10, "Land_fort_bagfence_round"],
	["Wall, Sandbag Fence (long)", 10, "Land_BagFenceLong"]
];
