...
switch(_selectedBox) do {
	...
	_currBox addWeaponCargoGlobal ["M16A2",2];
        ...
        _currBox addMagazineCargoGlobal ["200Rnd_556x45_M249",24];
	...
	_currBox addWeaponCargoGlobal ["M4A1_RCO_GL",3];
	...
	_currBox addMagazineCargoGlobal ["PG7V",2];
    };
	...
	_currBox addMagazineCargoGlobal ["20Rnd_B_AA12_HE",3];
	_currBox addMagazineCargoGlobal ["HandGrenade",10];
	...
	_currBox addMagazineCargoGlobal ["1Rnd_HE_M203",10];
	_currBox addMagazineCargoGlobal ["1Rnd_Smoke_M203",10];
	_currBox addMagazineCargoGlobal ["200Rnd_556x45_L110A1",3];
    };
    case "basicSpecial3": { // Misc weapons, nice stuff
