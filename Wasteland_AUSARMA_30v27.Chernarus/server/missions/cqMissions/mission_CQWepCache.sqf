...
EnemyGrpCQ = createGroup east;
[EnemyGrpCQ,_randomPos, east] spawn createLargeGroup;
...
waitUntil
{
    ...
    _unitsAlive = ({alive _x} count units EnemyGrpCQ);
...
if(_result == 1) then
{
	//Mission Failed.
    deleteVehicle _box;
    {deleteVehicle _x;}forEach units EnemyGrpCQ;
    deleteGroup EnemyGrpCQ;
