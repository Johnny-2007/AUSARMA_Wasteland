...
_hint = parseText format ["<t align='center' color='%2' shadow='2' size='1.75'>Side Objective</t><br/><t align='center' color='%2'>------------------------------</t><br/><t align='center' color='%3' size='1.25'>%1</t><br/><t align='center' color='%3'>A supply cache has been spotted near the marker!</t>", _missionType,  sideMissionColor, subTextColor];
[nil,nil,rHINT,_hint] call RE;

EnemyGrpS = createGroup east;
[EnemyGrpS,_randomPos,east] spawn createSmallGroup;
